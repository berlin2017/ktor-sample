...
<div class="container content">
    ...
    <div class="view row">
        <div class="span12 margin-bottom-30 " id="appicon-bg">
            <img src="https://appicon.pgyer.com/image/view/app_icons/690dd516529ffe073b5e6a2c3e27adb0/120" class="appicon" onerror="javascript:this.src='https://static.pgyer.com/static-20200109/assets/img/default-icon.png';" />
        </div>
        <div class="span12" style="text-align:center;padding-top:10px;">
            <h2 style="color:#333;size:24px;margin-bottom: -5px;">
                政务新媒体                            <span class="label label-danger signature-label signature_in_house">企业版</span>
            </h2>
        </div>

        <div class="span12 gray-text" style="text-align:center;">
            <ul class="breadcrumb pb-20" >
                <li>版本：1.0.8 (build 9)</li>
                <li>大小：36.7 MB</li>
                <li >更新时间：2 天前</li>
            </ul>
        </div>
