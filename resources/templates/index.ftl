...
<#include "login.ftl"/>
<button class="loginBtn mdui-center mdui-btn mdui-color-green mdui-text-color-white mdui-ripple ">Get Started<i class="mdui-icon material-icons"  >share</i></button>
</body>
</html>
